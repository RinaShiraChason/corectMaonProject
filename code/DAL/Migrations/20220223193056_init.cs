        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNamber2 = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecoverLostsDate = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdActivityUpdate = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DailyActivityDate = table.Column<DateTime>(type: "date", nullable: false),
                    DailyActivitySubject = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalDataDate = table.Column<DateTime>(type: "date", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    TeacherId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageDate = table.Column<DateTime>(type: "date", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    TeacherId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KidId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameKid = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
                    TzKid = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    AgeKid = table.Column<float>(type: "float", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdDayCare = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateCare = table.Column<DateTime>(type: "date", nullable: false),
                    BehaviorDayCare = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
                    DressDayCare = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
                    CommentDayCare = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
                    SleepDayCare = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
                    FoodDayCare = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: false),
                    KidId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageDateTime = table.Column<DateTime>(type: "date", nullable: false),
